 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("David Byas-Smith");
		  toPrint += p1.toString("902446857");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Jaron Gao");
		  toPrint += p2.toString("902481391");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Stephen Bentley");
		  toPrint += p3.toString("902448129");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Robert Heck");
          toPrint += p4.toString("902778774");
		  //Person5 replace P5 with your name
          //and ggg000x with your gt num
          Person5 p5 = new Person5("Devraj Mehta");
          toPrint += p5.toString("902672705");
